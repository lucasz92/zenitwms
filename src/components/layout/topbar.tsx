...
import { Bell, PanelLeftClose, PanelLeftOpen, Search, Sun, Moon } from "lucide-react";
        ...
        <header className="relative flex h-14 shrink-0 items-center gap-3 border-b bg-background/95 backdrop-blur-sm px-4">
            ...
            <div className="flex items-center gap-1.5">
                ...
                >
                    ...
                    {/* Dot azul eléctrico */}
                    <span className="absolute right-1.5 top-1.5 h-1.5 w-1.5 rounded-full" style={{ background: "#007BFF" }} />
                </Button>
